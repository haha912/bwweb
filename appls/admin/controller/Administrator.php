...
use app\admin\model\Admincontrol;
...
class Administrator extends AdminAuth
{
    ...
    {
        $list =  Admincontrol::where('status','>=','0')->order('id', 'ASC')->paginate();
    ...
    public function update($id)
    {
        ...
        if ($user->update($data)) {
            if(isset($data['avatar'])){session('admin_avatar',$data['avatar']);}            
