<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:67:"D:\root\web\bwweb\public/../appls/admin\view\usermanage\faqmng.html";i:1527582355;s:46:"D:\root\web\bwweb\appls\admin\view\layout.html";i:1489735872;s:46:"D:\root\web\bwweb\appls\admin\view\header.html";i:1527369943;s:44:"D:\root\web\bwweb\appls\admin\view\left.html";i:1527696318;s:46:"D:\root\web\bwweb\appls\admin\view\footer.html";i:1527108086;}*/ ?>
<!DOCTYPE html>
...
<section id="content">
    ...
    <div class="page page-fullwidth-layout">
        ...
        <div class="pageheader">
            ...
            <div class="page-bar">
                ...
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="<?php echo url($data['module_url']); ?>">FAQ列表</a>
                    </li>
                </ul>
                ...
                <div class="col-md-12">
                    ...
                    <section class="tile">
                        ...
                        <div class="tile-header dvd dvd-btm">
                            <h1 class="custom-font"><strong>FAQ</strong> 列表</h1>
                            <ul class="controls">
                                <li><a href="<?php echo url($data['module_url'].'create_faq'); ?>"><i class="fa fa-plus mr-5"></i> 新增</a></li>
                            </ul>
                        </div>
                        <!-- /tile header -->
                                ...
                                <table class="table table-striped table-hover table-custom" id="products-list">
                                                ...
                                                <div class="col-xs-6" style='padding:0px 0px 4px 0px;'>
                                                    <div class="form-group" style='margin-bottom: 0px;'>
                                                        <select  name="typeselect" class="form-control" onchange="self.location.href=options[selectedIndex].value" style="max-width: 300px;">
                                                                    <option <?php if(!strcmp($data['type_select_faq'],'all')): ?> selected="selected"<?php endif; ?>
                                                                        value="<?php echo url($data['module_url'].'faqmng/all'); ?>">全部</option>
                                                                    <option <?php if(!strcmp((string)($data['type_select_faq']),'0')): ?> selected="selected"<?php endif; ?>
                                                                        value="<?php echo url($data['module_url'].'faqmng/0'); ?>">未答复</option>
                                                                    <option <?php if($data['type_select_faq'] == 1): ?> selected="selected"<?php endif; ?>
                                                                        value="<?php echo url($data['module_url'].'faqmng/1'); ?>">显示</option>
                                                                    <option <?php if($data['type_select_faq'] == 2): ?> selected="selected"<?php endif; ?>
                                                                        value="<?php echo url($data['module_url'].'faqmng/2'); ?>">隐藏</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            </th>
                                    ...
                                    <tbody>                                        
                                        <?php if(($list)): foreach($list as $item): ?>
                                                ...
                                                <td>
                                                    <a class="btn btn-info" href="<?php echo url($data['module_url'].'read_faq'.'/'.$item->id); ?>">
        ...
        function deleteData(id){
            $.ajax({
                type:"POST",
                url:"<?php echo $data['module_url']; ?>delete_faq/"+id,
