<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:70:"D:\root\web\bwweb\public/../appls/admin\view\teammanage\read_team.html";i:1527699876;s:46:"D:\root\web\bwweb\appls\admin\view\layout.html";i:1489735872;s:46:"D:\root\web\bwweb\appls\admin\view\header.html";i:1527369943;s:44:"D:\root\web\bwweb\appls\admin\view\left.html";i:1527696318;s:52:"D:\root\web\bwweb\appls\admin\view\admin-fields.html";i:1527699010;s:46:"D:\root\web\bwweb\appls\admin\view\footer.html";i:1527108086;}*/ ?>
<!DOCTYPE html>
                    ...
                    <div class="col-md-12">
                        ...
                        <section class="tile">
                            ...
                            <div class="tile-body">
                                ...
                                <form role="form" enctype="multipart/form-data" action="<?php echo url($data['module_url'].'update_mem'.'/'.$item->id); ?>" method="post">
...
<?php if(is_array($data['edit_fields']) || $data['edit_fields'] instanceof \think\Collection || $data['edit_fields'] instanceof \think\Paginator): if( count($data['edit_fields'])==0 ) : echo "" ;else: foreach($data['edit_fields'] as $key=>$field): switch($name=$field['type']): case "text": if(isset($field['extra']['wrapper'])): ?>
        ...
        <?php break; default: endswitch; endforeach; endif; else: echo "" ;endif; ?>
                                ...
                                <button class="btn btn-lg btn-primary" type="submit"><i class="glyphicon glyphicon-ok"></i>&nbsp;确认修改</button>
