<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:61:"D:\root\web\bwweb\public/../appls/admin\view\index\index.html";i:1527704015;s:46:"D:\root\web\bwweb\appls\admin\view\layout.html";i:1489735872;s:46:"D:\root\web\bwweb\appls\admin\view\header.html";i:1527369943;s:44:"D:\root\web\bwweb\appls\admin\view\left.html";i:1527696318;s:46:"D:\root\web\bwweb\appls\admin\view\footer.html";i:1527108086;}*/ ?>
<!DOCTYPE html>
                ...
                <div class="card">
                    <div class="front bg-red">
                        ...
                        <div class="row">
                            ...
                            <!-- /col -->
                            <!-- col -->
                            <div class="col-xs-4" style = "border-right:1px">
                                <p class="text-elg text-strong mb-0"><?php echo $data['post_count_type']; ?></p>
                                <span>待处理</span>
                            </div>
                            <div class="col-xs-4" style = 'padding-left:0px'>
                                <u1 style = "list-style:none">
                                    <li><i class="fa fa-id-badge" aria-hidden="true"></i><b> 联系:&nbsp<?php echo $data['post_count_contact']; ?></b></li>
                                    <li><b><i class="fa fa-question-circle" aria-hidden="true"></i> FAQ:&nbsp<?php echo $data['post_count_faq']; ?></b></li>
                                    <li><b><i class="fa fa-plus" aria-hidden="true"></i> 订阅:&nbsp<?php echo $data['post_count_subscribe']; ?></b></li>       
                                </u1>                         
                            </div>
                            <!-- /col -->
                        </div>
                    ...
                    <div class="back bg-slategray">
                        ...
                        <div class="row">
                            <!-- col -->
                            <div class="col-xs-6">
                                <a href="<?php echo url('/admin/usermanage'); ?>"><i class="fa fa-chain-broken fa-2x"></i> 详细</a>
                            </div>
                            <!-- /col -->
                            <!-- col -->
                            <div class="col-xs-6">
                                <a href="<?php echo url('/admin/usermanage'); ?>"><i class="fa fa-ellipsis-h fa-2x"></i> 更多</a>
                            </div>
                            <!-- /col -->
                        </div>
                        <!-- /row -->
                ...
                <div class="card">
                    ...
                    <div class="back bg-blue">
                        ...
                        <div class="row">
                            ...
                            <!-- col -->
                            <div class="col-xs-12">
                                <a href="<?php echo url('/admin/blogmng'); ?>"><i class="fa fa-ellipsis-h fa-2x"></i> 更多</a>
                            </div>
                            <!-- /col -->
                ...
                <div class="card">
                    <div class="front bg-greensea">
                        ...
                        <div class="row">
                            ...
                            <!-- col -->
                            <div class="col-xs-8">
                                <p style = 'font-size:18px'>日用户量:<?php echo $data['visit_count_all']; ?></p>
                                <p style = 'font-size:18px'>PV: <?php echo $data['pv_count_all']; ?></p>
                            </div>
                            <!-- /col -->
                        </div>
                        <!-- /row -->
                    ...
                    <div class="back bg-greensea">
                        ...
                        <div class="row">
                            <!-- col -->
                            <div class="col-xs-6">
                                <a href="#"><i class="fa fa-info fa-2x"></i> 查看</a>
                            </div>
                            <!-- /col -->
                            <!-- col -->
                            <div class="col-xs-6">
                                <a href="#"><i class="fa fa-plus fa-2x"></i> 新增</a>
                            </div>
                            <!-- /col -->
                        </div>
                        <!-- /row -->
