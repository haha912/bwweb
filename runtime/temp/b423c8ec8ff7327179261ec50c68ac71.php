<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:64:"D:\root\web\bwweb\public/../appls/admin\view\exam\lostfound.html";i:1527103760;s:46:"D:\root\web\bwweb\appls\admin\view\layout.html";i:1489735872;s:46:"D:\root\web\bwweb\appls\admin\view\header.html";i:1527188422;s:44:"D:\root\web\bwweb\appls\admin\view\left.html";i:1527193834;s:46:"D:\root\web\bwweb\appls\admin\view\footer.html";i:1527108086;}*/ ?>
<!DOCTYPE html>
                    ...
                    <div id="sidebarNav" class="panel-collapse collapse in" role="tabpanel">
                        <div class="panel-body">
                            ...
                            <ul id="navigation">
                                ...
                                <li class="usermanage">
                                    <a role="button" tabindex="0"><i class="fa fa-list" aria-hidden="true"></i> <span>用户管理</span></a>
                                    <ul>
                                        <li><a class="ajax-link" href="<?php echo url('/admin/exam'); ?>"><i class="fa fa-caret-right" aria-hidden="true"></i>FAQ</a></li>
                                        <li><a class="ajax-link" href="<?php echo url('/admin/exam/create'); ?>"><i class="fa fa-caret-right"></i>联系我们</a></li>
										<li><a class="ajax-link" href="<?php echo url('/admin/exam/lostfound'); ?>"><i class="fa fa-caret-right"></i>订阅</a></li>
                                    </ul>
                                </li>
                                <li class="blogmanage">
        ...
        <div class="pageheader">
            ...
            <div class="page-bar">
                ...
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="<?php echo url($data['module_url']); ?>">回收站列表</a>
                    </li>
                </ul>
                ...
                <div class="col-md-12">
                    ...
                    <section class="tile">
                        ...
                        <div class="tile-header dvd dvd-btm">
                            <h1 class="custom-font"><strong>最近删除文件</strong> 列表</h1>
                        </div>
                        <!-- /tile header -->
                                    ...
                                    <tbody>
                                        ...
                                        <?php if(($list)): foreach($list as $item): ?>
                                            <tr id="tr_<?php echo $item->id; ?>">
                                                ...
                                                <td><?php $ansABCD=['',$item->ansa,$item->ansb,$item->ansc,$item->ansd];echo $ansABCD[$item->trueans];?></td>
												<td><?php echo $item->delete_time; ?></td>
												<td><?php echo $item->status; ?></td>
                                                <td>
                                                    <a class="btn btn-warning" href="javascript:;"  onclick="if(confirm('确定恢复该试题吗？')){ updateExpireTime(<?php echo $item->id; ?>)}">
                                                        <i class="glyphicon glyphicon-time icon-white"></i>
														恢复
                                                    </a>
                                                    <a class="btn btn-danger" href="javascript:;"  onclick="if(confirm('确定要彻底删除该试题吗？')){ deleteData(<?php echo $item->id; ?>)}">
