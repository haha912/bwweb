<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:75:"D:\root\web\bwweb\public/../appls/admin\view\usermanage\read_subscribe.html";i:1527274099;s:46:"D:\root\web\bwweb\appls\admin\view\layout.html";i:1489735872;s:46:"D:\root\web\bwweb\appls\admin\view\header.html";i:1527305208;s:44:"D:\root\web\bwweb\appls\admin\view\left.html";i:1527358130;s:53:"D:\root\web\bwweb\appls\admin\view\custom-fields.html";i:1527188646;s:46:"D:\root\web\bwweb\appls\admin\view\footer.html";i:1527108086;}*/ ?>
<!DOCTYPE html>
...
<?php if(is_array($data['edit_fields']) || $data['edit_fields'] instanceof \think\Collection || $data['edit_fields'] instanceof \think\Paginator): if( count($data['edit_fields'])==0 ) : echo "" ;else: foreach($data['edit_fields'] as $key=>$field): switch($name=$field['type']): case "text": if(isset($field['extra']['wrapper'])): ?>
        ...
        <?php break; default: endswitch; endforeach; endif; else: echo "" ;endif; ?>
                                ...
                                <?php if(!strcmp($item['status'],'待处理')): ?><a href ="<?php echo url($data['module_url'].'confirm_subscribe/'.$item->id); ?>" class="btn btn-lg btn-primary"><i class="glyphicon glyphicon-ok"></i>&nbsp;标记为已处理</a><?php endif; ?>
                                <a href ="<?php echo url($data['module_url'].'/subscribemng/all'); ?>" class="btn btn-lg btn-primary" ><i class="fa fa-chevron-left"></i>&nbsp;返回</a>
                            </div>
                            <!-- /tile body -->
