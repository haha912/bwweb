<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:66:"D:\root\web\bwweb\public/../appls/admin\view\teammanage\index.html";i:1527703688;s:46:"D:\root\web\bwweb\appls\admin\view\layout.html";i:1489735872;s:46:"D:\root\web\bwweb\appls\admin\view\header.html";i:1527369943;s:44:"D:\root\web\bwweb\appls\admin\view\left.html";i:1527696318;s:46:"D:\root\web\bwweb\appls\admin\view\footer.html";i:1527108086;}*/ ?>
<!DOCTYPE html>
...
<section id="content">
    ...
    <div class="page page-fullwidth-layout">
                ...
                <div class="col-md-12">
                    ...
                    <section class="tile">
                        ...
                        <div class="tile-body">
                                ...
                                <table class="table table-striped table-hover table-custom" id="products-list">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style='padding-bottom:0px;'>
                                                <div class="col-xs-3" style='padding:8px 0px 0px 0px;width: 45px;'>类型
                                                </div>
                                                    ...
                                                    <div class="form-group" style='margin-bottom: 0px;'>
                                                        <select  name="typeselect" class="form-control" onchange="self.location.href=options[selectedIndex].value" style="max-width: 300px;">
                                                                    ...
                                                                    <option <?php if(!strcmp((string)($data['type_select']),'0')): ?> selected="selected"<?php endif; ?>
                                                                        value="<?php echo url($data['module_url'].'0'); ?>">核心团队</option>
                                                                    <option <?php if($data['type_select'] == 1): ?> selected="selected"<?php endif; ?>
                                                                        value="<?php echo url($data['module_url'].'1'); ?>">顾问团队</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            </th>
                                    ...
                                    <tbody>                                        
                                        <?php if(($list)): foreach($list as $item): ?>
                                                ...
                                                <?php $typename = array(0=>'核心团队', 1=> '顾问团队')?>
                                                <td><?php echo $typename[$item['type']]; ?></td>                                             
                                                <td>
                                                    <a class="btn btn-info" href="<?php echo url($data['module_url'].'read_team'.'/'.$item->id); ?>">
                                                        <i class="glyphicon glyphicon-edit icon-white"></i>
                                                        编辑
                                                    </a>
                                                    <a class="btn btn-danger" href="javascript:;"  onclick="if(confirm('确定要删除该成员吗？')){ deleteData(<?php echo $item->id; ?>) }">
                           ...
                           <?php if((!count($list))): ?><div id="nobject" style="text-align:center;margin-top:15px;">暂无成员！</div><?php endif; ?>
        ...
        function deleteData(id){
            $.ajax({
                type:"POST",
                url:"<?php echo $data['module_url']; ?>delete_mem/"+id,
