<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:68:"D:\root\web\bwweb\public/../appls/admin\view\administrator\read.html";i:1527185604;s:46:"D:\root\web\bwweb\appls\admin\view\layout.html";i:1489735872;s:46:"D:\root\web\bwweb\appls\admin\view\header.html";i:1527369943;s:44:"D:\root\web\bwweb\appls\admin\view\left.html";i:1527696318;s:52:"D:\root\web\bwweb\appls\admin\view\admin-fields.html";i:1527698758;s:46:"D:\root\web\bwweb\appls\admin\view\footer.html";i:1527108086;}*/ ?>
<!DOCTYPE html>
                    ...
                    <div class="col-md-12">
                        ...
                        <section class="tile">
                            ...
                            <div class="tile-body">
                                ...
                                <form role="form" enctype="multipart/form-data" action="<?php echo url($data['module_url'].'update/'.$item['id']); ?>" method="post">
...
<?php if(is_array($data['edit_fields']) || $data['edit_fields'] instanceof \think\Collection || $data['edit_fields'] instanceof \think\Paginator): if( count($data['edit_fields'])==0 ) : echo "" ;else: foreach($data['edit_fields'] as $key=>$field): switch($name=$field['type']): case "text": if(isset($field['extra']['wrapper'])): ?>
            ...
            <?php endif; ?>
                <div class="form-group">
                    ...
                    <?php if(isset($item[$key]) AND $item[$key] != ""): ?>
                        ...
                        <a href="<?php echo url($data['module_url'] . 'delete_image/' . $item['id']); ?>" class="btn btn-danger"   onclick="return del('真的要删除吗?')"><i class="glyphicon glyphicon-trash"></i> Delete</a>
        ...
        <?php break; case "radio_team": if(isset($field['extra']['wrapper'])): ?>
                <div class="<?php echo $field['extra']['wrapper'];?>">
            <?php else: ?>
                <div class="col-xs-12">
            <?php endif; ?>
