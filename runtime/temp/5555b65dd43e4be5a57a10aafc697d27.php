<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:60:"D:\root\web\bwweb\public/../appls/admin\view\exam\index.html";i:1527270459;s:46:"D:\root\web\bwweb\appls\admin\view\layout.html";i:1489735872;s:46:"D:\root\web\bwweb\appls\admin\view\header.html";i:1527305208;s:44:"D:\root\web\bwweb\appls\admin\view\left.html";i:1527358130;s:46:"D:\root\web\bwweb\appls\admin\view\footer.html";i:1527108086;}*/ ?>
<!DOCTYPE html>
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th style='padding-bottom:0px;'>
												<div class="col-xs-3" style='padding:8px 0px 0px 0px;width: 45px;'>科目：
												</div>
												<div class="col-xs-6" style='padding:0px 0px 4px 0px;'>
													<div class="form-group" style='margin-bottom: 0px;'>
														<select  name="typeselect" class="form-control" onchange="self.location.href=options[selectedIndex].value" style="max-width: 300px;">																
																<?php foreach($etype as $ov => $ol): ?> 
																	<option <?php if($data['type_select'] == $ol): ?>selected="selected"<?php endif; ?> 
																		value="<?php echo url($data['module_url'].$ol); ?>"><?php echo $ol; ?></option>
																<?php endforeach; ?>
														</select>
													</div>
												</div>
                                    ...
                                    <tbody>
                                        ...
                                        <?php if(($list)): foreach($list as $item): ?>
                                            <tr id="tr_<?php echo $item->id; ?>">
                                                ...
                                                <td>
                                                    <a class="btn btn-info" href="<?php echo url($data['module_url'].'read').'/'.$item->id; ?>">
                                                        <i class="glyphicon glyphicon-edit icon-white"></i>
                                                        编辑
                                                    </a>
                                                    <a class="btn btn-warning" href="javascript:;"  
														onclick="if(confirm(<?php if ($item->status =='正常'){ ?>'确定停用该试题吗？'<?php }else{ ?>'确定要启用该试题吗？'<?php } ?>)){ updateExpireTime(<?php echo $item->id; ?>)}"
														<?php if ($item->status =='已停用'){ ?>style="background-color: #7fd064;border-color: #7fd064;"<?php } ?> >
                                                        <i class="glyphicon glyphicon-time icon-white"></i>
                                                    <?php if ($item->status =='正常'){ ?>停用<?php }else{ ?>启用<?php } ?>
                                                    </a>
                                                    <a class="btn btn-danger" href="javascript:;"  onclick="if(confirm('确定要将该试题放入回收站吗？')){ deleteData(<?php echo $item->id; ?>)}">
