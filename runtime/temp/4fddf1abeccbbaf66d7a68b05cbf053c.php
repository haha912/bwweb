<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:63:"D:\root\web\bwweb\public/../appls/admin\view\blogmng\index.html";i:1527696434;s:46:"D:\root\web\bwweb\appls\admin\view\layout.html";i:1489735872;s:46:"D:\root\web\bwweb\appls\admin\view\header.html";i:1527369943;s:44:"D:\root\web\bwweb\appls\admin\view\left.html";i:1527696318;s:46:"D:\root\web\bwweb\appls\admin\view\footer.html";i:1527108086;}*/ ?>
<!DOCTYPE html>
...
<section id="content">
    ...
    <div class="page page-fullwidth-layout">
                                ...
                                <table class="table table-striped table-hover table-custom" id="products-list">
                                                    ...
                                                    <div class="form-group" style='margin-bottom: 0px;'>
                                                        <select  name="typeselect" class="form-control" onchange="self.location.href=options[selectedIndex].value" style="max-width: 300px;">
                                                                    ...
                                                                    <option <?php if(!strcmp((string)($data['type_select']),'0')): ?> selected="selected"<?php endif; ?>
                                                                        value="<?php echo url($data['module_url'].'0'); ?>">显示</option>
                                                                    <option <?php if($data['type_select'] == 1): ?> selected="selected"<?php endif; ?>
                                                                        value="<?php echo url($data['module_url'].'1'); ?>">隐藏</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            </th>
                                    ...
                                    <tbody>                                        
                                        <?php if(($list)): foreach($list as $item): ?>
                                                ...
                                                <td>
                                                    <a class="btn btn-info" href="<?php echo url($data['module_url'].'read_blog'.'/'.$item->id); ?>">
        ...
        function deleteData(id){
            $.ajax({
                type:"POST",
                url:"<?php echo $data['module_url']; ?>delete_blog/"+id,
