<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:69:"D:\root\web\bwweb\public/../appls/admin\view\usermanage\read_faq.html";i:1527276020;s:46:"D:\root\web\bwweb\appls\admin\view\layout.html";i:1489735872;s:46:"D:\root\web\bwweb\appls\admin\view\header.html";i:1527369943;s:44:"D:\root\web\bwweb\appls\admin\view\left.html";i:1527364967;s:53:"D:\root\web\bwweb\appls\admin\view\custom-fields.html";i:1527686624;s:46:"D:\root\web\bwweb\appls\admin\view\footer.html";i:1527108086;}*/ ?>
<!DOCTYPE html>
                    ...
                    <div class="col-md-12">
                        ...
                        <section class="tile">
                            ...
                            <div class="tile-body">
                                ...
                                <form role="form" enctype="multipart/form-data" action="<?php echo url($data['module_url'].'update_faq'.'/'.$item->id); ?>" method="post">
...
<?php if(is_array($data['edit_fields']) || $data['edit_fields'] instanceof \think\Collection || $data['edit_fields'] instanceof \think\Paginator): if( count($data['edit_fields'])==0 ) : echo "" ;else: foreach($data['edit_fields'] as $key=>$field): switch($name=$field['type']): case "text": if(isset($field['extra']['wrapper'])): ?>
        ...
        <?php break; default: endswitch; endforeach; endif; else: echo "" ;endif; ?>
                                ...
                                <a href ="<?php echo url($data['module_url'].'/faqmng/all'); ?>" class="btn btn-lg btn-primary" ><i class="fa fa-chevron-left"></i>&nbsp;返回</a>
                                </form>
                            </div>
                            <!-- /tile body -->
