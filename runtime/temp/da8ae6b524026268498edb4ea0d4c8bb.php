<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:73:"D:\root\web\bwweb\public/../appls/admin\view\usermanage\subscribemng.html";i:1527582376;s:46:"D:\root\web\bwweb\appls\admin\view\layout.html";i:1489735872;s:46:"D:\root\web\bwweb\appls\admin\view\header.html";i:1527369943;s:44:"D:\root\web\bwweb\appls\admin\view\left.html";i:1527364967;s:46:"D:\root\web\bwweb\appls\admin\view\footer.html";i:1527108086;}*/ ?>
<!DOCTYPE html>
...
<section id="content">
    ...
    <div class="page page-fullwidth-layout">
        ...
        <div class="pageheader">
            ...
            <div class="page-bar">
                ...
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="<?php echo url($data['module_url']); ?>">订阅列表</a>
                    </li>
                </ul>
                                ...
                                <table class="table table-striped table-hover table-custom" id="products-list">
                                                ...
                                                <div class="col-xs-6" style='padding:0px 0px 4px 0px;'>
                                                    <div class="form-group" style='margin-bottom: 0px;'>
                                                        <select  name="typeselect" class="form-control" onchange="self.location.href=options[selectedIndex].value" style="max-width: 300px;">
                                                                    <option <?php if(!strcmp($data['type_select_sub'],'all')): ?> selected="selected"<?php endif; ?>
                                                                        value="<?php echo url($data['module_url'].'subscribemng/all'); ?>">全部</option>
                                                                    <option <?php if(!strcmp((string)($data['type_select_sub']),'0')): ?> selected="selected"<?php endif; ?>
                                                                        value="<?php echo url($data['module_url'].'subscribemng/0'); ?>">待处理</option>
                                                                    <option <?php if($data['type_select_sub'] == 1): ?> selected="selected"<?php endif; ?>
                                                                        value="<?php echo url($data['module_url'].'subscribemng/1'); ?>">已阅</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            </th>
                                    ...
                                    <tbody>                                        
                                        <?php if(($list)): foreach($list as $item): ?>
                                                ...
                                                <td>
                                                    <a class="btn btn-info" href="<?php echo url($data['module_url'].'read_subscribe'.'/'.$item->id); ?>">
        ...
        function deleteData(id){
            $.ajax({
                type:"POST",
                url:"<?php echo $data['module_url']; ?>delete_subscribe/"+id,
