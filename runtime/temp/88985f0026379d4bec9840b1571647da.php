<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:62:"D:\root\web\bwweb\public/../appls/home\view\blog\blogpost.html";i:1527688935;s:45:"D:\root\web\bwweb\appls\home\view\layout.html";i:1497688788;s:45:"D:\root\web\bwweb\appls\home\view\header.html";i:1527687349;s:45:"D:\root\web\bwweb\appls\home\view\footer.html";i:1527682386;}*/ ?>
<!DOCTYPE html>
		...
		<div class="row">
			<div class="col-md-12">
				<ol class="breadcrumb">
					...
					<li class="active"><?php echo ldf('详情','Detail'); ?></li>
				</ol>
			</div>
		</div>
	</div>
	...
	<div class="container">
		<div class="row">
			...
			<div class="main col-md-8">
				...
				<!-- page-title start -->
				<!-- ================ -->
				<h1 class="page-title"><?php echo ldf($item['title'],$item['title_en']); ?></h1>
				<!-- page-title end -->
				...
				<article class="clearfix blogpost full">
					<div class="blogpost-body">
						<div class="side">
							<div class="post-info">
								<span class="day"><?php $tsplit = explode("-",$item['time']); echo $tsplit[2]; ?></span>
						...
						<div class="blogpost-content">
							<header>
								<div class="submitted"><i class="fa fa-user pr-5"></i> by <a href="#"><?php echo $item['author']; ?></a></div>
							</header>
							<div class="owl-carousel content-slider-with-controls">
								<div class="overlay-container">
									<img src="<?php echo str_replace('_thumb', '',$item['cover']); ?>" alt="">
									<a href="<?php echo str_replace('_thumb', '',$item['cover']); ?>" class="popup-img overlay" title="image title"><i class="fa fa-search-plus"></i></a>
								</div>
							</div>
							<?php echo ldf($item['contents'],$item['contents_en']); ?>
						</div>
					</div>
					<footer class="clearfix">
						<ul class="links pull-left">
							<?php $lsplit = explode("+",$item['labels']); ?>
							<li><i class="fa fa-tags pr-5"></i> 
								<?php foreach($lsplit as $lo): ?> <a href="#"><?php echo $lo; ?>. </a> <?php endforeach; ?>
							</li>
						</ul>
					</footer>
				</article>
