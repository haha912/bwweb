<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:61:"D:\root\web\bwweb\public/../appls/admin\view\exam\create.html";i:1527103754;s:46:"D:\root\web\bwweb\appls\admin\view\layout.html";i:1489735872;s:46:"D:\root\web\bwweb\appls\admin\view\header.html";i:1527188422;s:44:"D:\root\web\bwweb\appls\admin\view\left.html";i:1527194661;s:51:"D:\root\web\bwweb\appls\admin\view\exam-fields.html";i:1510855989;s:46:"D:\root\web\bwweb\appls\admin\view\footer.html";i:1527108086;}*/ ?>
<!DOCTYPE html>
                        ...
                        <div class="panel-body">
                            ...
                            <ul id="navigation">
                                ...
                                <li class="usermanage">
                                    ...
                                    <ul>
                                        <li><a class="ajax-link" href="<?php echo url('/admin/usermanage'); ?>"><i class="fa fa-caret-right" aria-hidden="true"></i>FAQ</a></li>
                                        <li><a class="ajax-link" href="<?php echo url('/admin/usermanage/create'); ?>"><i class="fa fa-caret-right"></i>联系我们</a></li>
										<li><a class="ajax-link" href="<?php echo url('/admin/usermanage/lostfound'); ?>"><i class="fa fa-caret-right"></i>订阅</a></li>
                                    </ul>
                                </li>
                                <li class="blogmanage">
                                    ...
                                    <ul>
                                        ...
                                        <li><a class="ajax-link" href="<?php echo url('/admin/blogmng/lostfound'); ?>"><i class="fa fa-caret-right"></i>回收站</a></li>
                                    </ul>
                                </li>                                
                            </ul>
                            <!--/ NAVIGATION Content -->
                    ...
                    <div class="col-md-12">
                        ...
                        <section class="tile">
                            ...
                            <div class="tile-header dvd dvd-btm">
                                <h1 class="custom-font"><strong>试题 </strong> 基本信息</h1>
                            </div>
                            <!-- /tile header -->
...
<?php if(is_array($data['edit_fields']) || $data['edit_fields'] instanceof \think\Collection || $data['edit_fields'] instanceof \think\Paginator): if( count($data['edit_fields'])==0 ) : echo "" ;else: foreach($data['edit_fields'] as $key=>$field): switch($name=$field['type']): case "text": if(isset($field['extra']['wrapper'])): ?>
            ...
            <?php endif; ?>
                <div class="form-group">
                    ...
                    <?php if(isset($item[$key]) AND $item[$key] != ""): ?>
                        <a href="/uploads/<?php echo $item[$key]; ?>" target="_blank"><img src="/uploads/<?php echo $item[$key]; ?>" class="img-responsive img-thumbnail"></a>
                    ...
                    <?php if(isset($field['label']) AND $field['label']): ?><span><?php echo $field['label']; ?></span><?php endif; foreach($field['default'] as $ov => $ol): ?>
                        <label>
                            <input type="<?php echo $field['type']; ?>" name="<?php echo $key; ?>"
                                ...
                                value="<?php echo $ov; ?>" <?php if((isset($item[$key]) && $item[$key] == $ov)): ?>
        ...
        <?php break; case "select": if(isset($field['extra']['wrapper'])): ?>
            ...
            <?php endif; ?>
                <div class="form-group">
                    <?php if(isset($field['label']) AND $field['label']): ?><div stytle='float:left'><label><?php echo $field['label']; ?></label></div><?php endif; ?>
                    ...
                    <select
                        ...
                        class="form-control" >					
                            <?php foreach($field['default'] as $ov => $ol): ?>
                                <option value="<?php echo $ol; ?>" <?php if(isset($item[$key]) AND $item[$key] == $ol): ?>selected="selected"<?php endif; ?>><?php echo $ol; ?></option>
                            <?php endforeach; ?>
					</select> 
					</span>
					<input  
        ...
        <?php break; case "textnum": if(isset($field['extra']['wrapper'])): ?>
                <div class="<?php echo $field['extra']['wrapper'];?>">
            <?php else: if(strcmp($key,'slow')): ?> <div class="col-xs-12" style="float:left;padding-right:0px;width:175px;margin-bottom:15px">
                <?php else: ?> <div class="col-xs-12" style="float:left;width:100%;margin-left:-30px;width:500px;margin-bottom:15px">
				<?php endif; endif; ?>
                <div class="form-group">
                    <?php if(isset($field['label']) AND $field['label']): ?><span style='float:left;height:34px;padding-top:7px;'><?php echo $field['label']; ?></span><?php endif; ?>
                    ...
                    <?php if(isset($field['notes']) AND $field['notes']): ?><span style='float:left;padding-top:10px;margin-left:5px;font-size:12px;'>(<?php echo $field['notes']; ?>)</span><?php endif; ?>
                </div>
            </div>
        <?php break; ?>
<!--         <?php case "timearea": if(isset($field['extra']['wrapper'])): ?>
                <div class="<?php echo $field['extra']['wrapper'];?>">
            <?php else: ?>
                <div class="col-xs-12">
            <?php endif; ?>
                <div class="form-group">
                    ...
                    <span sytle='float:left;'>
						<input 
							...
							class="form-control <?php if(isset($field['class']) AND $field['class']): ?><?php echo $field['class']; endif; ?>"
							<?php if(isset($field['extra']['data']['format'])): ?>data-format="<?php echo $field['extra']['data']['format']; ?>"<?php endif; ?>
							name="<?php echo $key; ?>" value="<?php if(isset($item[$key])): ?><?php echo $item[$key]; endif; ?>"> 到
					</span>
                    <?php if(isset($field['notes']) AND $field['notes']): ?><p class="help-block"><?php echo $field['notes']; ?></p><?php endif; ?>
                </div>
            </div>
        <?php break; ?>		 -->
        <?php case "textarea": if(isset($field['extra']['wrapper'])): ?>
                <div class="<?php echo $field['extra']['wrapper'];?>">
            <?php else: ?>
                <div class="col-xs-12">
            <?php endif; ?>
