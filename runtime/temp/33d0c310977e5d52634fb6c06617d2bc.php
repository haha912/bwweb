<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:64:"D:\root\web\bwweb\public/../appls/admin\view\blogmng\create.html";i:1527364484;s:46:"D:\root\web\bwweb\appls\admin\view\layout.html";i:1489735872;s:46:"D:\root\web\bwweb\appls\admin\view\header.html";i:1527369943;s:44:"D:\root\web\bwweb\appls\admin\view\left.html";i:1527696318;s:52:"D:\root\web\bwweb\appls\admin\view\admin-fields.html";i:1527578273;s:46:"D:\root\web\bwweb\appls\admin\view\footer.html";i:1527108086;}*/ ?>
<!DOCTYPE html>
...
<?php if(is_array($data['edit_fields']) || $data['edit_fields'] instanceof \think\Collection || $data['edit_fields'] instanceof \think\Paginator): if( count($data['edit_fields'])==0 ) : echo "" ;else: foreach($data['edit_fields'] as $key=>$field): switch($name=$field['type']): case "text": if(isset($field['extra']['wrapper'])): ?>
        ...
        <?php break; default: endswitch; endforeach; endif; else: echo "" ;endif; ?>
                                ...
                                <button class="btn btn-lg btn-primary" type="submit"><i class="glyphicon glyphicon-ok"></i>&nbsp;确认创建</button>
                                <a href ="<?php echo url($data['module_url'].'/blogmng/all'); ?>" class="btn btn-lg btn-primary" ><i class="fa fa-chevron-left"></i>&nbsp;返回</a>
                                </form>
                            </div>
                            <!-- /tile body -->
