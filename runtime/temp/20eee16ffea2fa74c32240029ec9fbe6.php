<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:69:"D:\root\web\bwweb\public/../appls/admin\view\administrator\index.html";i:1527268125;s:46:"D:\root\web\bwweb\appls\admin\view\layout.html";i:1489735872;s:46:"D:\root\web\bwweb\appls\admin\view\header.html";i:1527369943;s:44:"D:\root\web\bwweb\appls\admin\view\left.html";i:1527696318;s:46:"D:\root\web\bwweb\appls\admin\view\footer.html";i:1527108086;}*/ ?>
<!DOCTYPE html>
...
<section id="content">
    ...
    <div class="page page-fullwidth-layout">
                                        ...
                                        <?php if(($list)): foreach($list as $item): ?>
                                            <tr id="tr_<?php echo $item->id; ?>">
                                                ...
                                                <td>
                                                    ...
                                                    <a class="btn btn-warning" href="javascript:;"  onclick="if(confirm('确定使管理员账号过期吗')){ updateExpireTime(<?php echo $item->id; ?>)}">
        ...
        function deleteData(id){
            $.ajax({
                type:"POST",
                url:"<?php echo $data['module_url']; ?>delete/"+id,
